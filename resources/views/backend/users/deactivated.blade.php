...
@section('title', trans('navigation.backend.access.users.deactivated'))
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">{{ trans('navigation.backend.access.users.deactivated') }}</h3>
                ...
                <div class="card-body">
                    <table class="table table-striped table-valign-middle w-100" id="users-deactivated-table">
                        <thead>
                        <tr>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#users-deactivated-table').DataTable({
                processing: true,
                serverSide: true,
                lengthChange: false,
                searching: false,
                ajax: {
                    ...
                    type: 'POST',
                    data: {isActive: false, isTrashed: false}
                },
                columns: [
